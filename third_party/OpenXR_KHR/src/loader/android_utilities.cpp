...
static bool getCursor(wrap::android::content::Context &context, jni::Array<std::string> const &projection, Uri const &uri,
...
static int populateRuntimeFunctions(wrap::android::content::Context &context, bool systemBroker,
