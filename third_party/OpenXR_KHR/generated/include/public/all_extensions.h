...
#include <openxr/public/xr_androidx1_enumerate_system_extension_properties.h>
...
#define XR_LIST_PUBLIC_EXTENSIONS(_) \
    ...
    _(XR_ANDROIDX1_enumerate_system_extension_properties, 725)\
    ...
    _(XR_ANDROIDX2_geospatial_anchor, 798)\
