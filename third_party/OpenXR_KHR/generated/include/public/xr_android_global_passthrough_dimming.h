...
// Reflection macros
#define XR_LIST_STRUCT_XrSystemGlobalDimmingPropertiesANDROID(_) \
    _(type) \
    _(next) \
    _(supportsGlobalDimming)

#define XR_LIST_STRUCT_XrEventDataGlobalDimmingLevelChangedANDROID(_) \
    _(type) \
    _(next) \
    _(session)

#define XR_LIST_STRUCT_XrGlobalDimmingFrameEndInfoANDROID(_) \
    _(type) \
    _(next) \
    _(globalDimmingLevel)

#define XR_LIST_FUNCTIONS_XR_ANDROID_global_passthrough_dimming(_) \
    _(GetGlobalDimmingLevelANDROID, ANDROID_global_passthrough_dimming) \
    _(EnumerateSupportedGlobalDimmingLevelsANDROID, ANDROID_global_passthrough_dimming)
