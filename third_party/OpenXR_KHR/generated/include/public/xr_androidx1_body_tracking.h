...
typedef enum XrUpperBodyJointTypeANDROIDX1 {
    XR_UPPER_BODY_JOINT_TYPE_HIPS_ANDROIDX1 = 0,
    XR_UPPER_BODY_JOINT_TYPE_SPINE_ANDROIDX1 = 1,
    XR_UPPER_BODY_JOINT_TYPE_RIBS_ANDROIDX1 = 2,
    XR_UPPER_BODY_JOINT_TYPE_CHEST_ANDROIDX1 = 3,
    XR_UPPER_BODY_JOINT_TYPE_NECK_ANDROIDX1 = 4,
    XR_UPPER_BODY_JOINT_TYPE_HEAD_ANDROIDX1 = 5,
    XR_UPPER_BODY_JOINT_TYPE_LEFT_SHOULDER_ANDROIDX1 = 6,
    XR_UPPER_BODY_JOINT_TYPE_RIGHT_SHOULDER_ANDROIDX1 = 7,
    XR_UPPER_BODY_JOINT_TYPE_LEFT_UPPER_ARM_ANDROIDX1 = 8,
    XR_UPPER_BODY_JOINT_TYPE_RIGHT_UPPER_ARM_ANDROIDX1 = 9,
    XR_UPPER_BODY_JOINT_TYPE_LEFT_LOWER_ARM_ANDROIDX1 = 10,
    XR_UPPER_BODY_JOINT_TYPE_RIGHT_LOWER_ARM_ANDROIDX1 = 11,
    XR_UPPER_BODY_JOINT_TYPE_LEFT_HAND_ANDROIDX1 = 12,
    XR_UPPER_BODY_JOINT_TYPE_RIGHT_HAND_ANDROIDX1 = 13,
    XR_UPPER_BODY_JOINT_TYPE_ANDROIDX1_MAX_ENUM = 0x7FFFFFFF
} XrUpperBodyJointTypeANDROIDX1;

typedef enum XrFullBodyJointTypeANDROIDX1 {
    XR_FULL_BODY_JOINT_TYPE_HIPS_ANDROIDX1 = 0,
    XR_FULL_BODY_JOINT_TYPE_SPINE_ANDROIDX1 = 1,
    XR_FULL_BODY_JOINT_TYPE_RIBS_ANDROIDX1 = 2,
    XR_FULL_BODY_JOINT_TYPE_CHEST_ANDROIDX1 = 3,
    XR_FULL_BODY_JOINT_TYPE_NECK_ANDROIDX1 = 4,
    XR_FULL_BODY_JOINT_TYPE_HEAD_ANDROIDX1 = 5,
    XR_FULL_BODY_JOINT_TYPE_LEFT_SHOULDER_ANDROIDX1 = 6,
    XR_FULL_BODY_JOINT_TYPE_RIGHT_SHOULDER_ANDROIDX1 = 7,
    XR_FULL_BODY_JOINT_TYPE_LEFT_UPPER_ARM_ANDROIDX1 = 8,
    XR_FULL_BODY_JOINT_TYPE_RIGHT_UPPER_ARM_ANDROIDX1 = 9,
    XR_FULL_BODY_JOINT_TYPE_LEFT_LOWER_ARM_ANDROIDX1 = 10,
    XR_FULL_BODY_JOINT_TYPE_RIGHT_LOWER_ARM_ANDROIDX1 = 11,
    XR_FULL_BODY_JOINT_TYPE_LEFT_HAND_ANDROIDX1 = 12,
    XR_FULL_BODY_JOINT_TYPE_RIGHT_HAND_ANDROIDX1 = 13,
    XR_FULL_BODY_JOINT_TYPE_LEFT_UPPER_LEG_ANDROIDX1 = 14,
    XR_FULL_BODY_JOINT_TYPE_RIGHT_UPPER_LEG_ANDROIDX1 = 15,
    XR_FULL_BODY_JOINT_TYPE_LEFT_LOWER_LEG_ANDROIDX1 = 16,
    XR_FULL_BODY_JOINT_TYPE_RIGHT_LOWER_LEG_ANDROIDX1 = 17,
    XR_FULL_BODY_JOINT_TYPE_LEFT_FOOT_ANDROIDX1 = 18,
    XR_FULL_BODY_JOINT_TYPE_RIGHT_FOOT_ANDROIDX1 = 19,
    XR_FULL_BODY_JOINT_TYPE_LEFT_TOES_ANDROIDX1 = 20,
    XR_FULL_BODY_JOINT_TYPE_RIGHT_TOES_ANDROIDX1 = 21,
    XR_FULL_BODY_JOINT_TYPE_ANDROIDX1_MAX_ENUM = 0x7FFFFFFF
} XrFullBodyJointTypeANDROIDX1;
