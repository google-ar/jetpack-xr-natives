...
#define XR_LIST_ENUM_XrResult(_) \
    ...
    _(XR_ERROR_PERSIST_UUID_NOT_FOUND_EXT, -1000781002) \
...
#define XR_LIST_ENUM_XrStructureType(_) \
    ...
    _(XR_TYPE_SCENE_MESH_CPU_ANDROIDX, 1000705005) \
    ...
    _(XR_TYPE_SCENE_MESH_HARDWARE_ANDROIDX, 1000709000) \
    ...
    _(XR_TYPE_HEAD_TRACKING_ERROR_CAUSE_ANDROIDSYS, 1000734001) \
...
#define XR_LIST_ENUM_XrSceneMeshLevelOfDetailANDROIDX(_) \
    _(XR_SCENE_MESH_LEVEL_OF_DETAIL_MAX_ANDROIDX, 0) \
    _(XR_SCENE_MESH_LEVEL_OF_DETAIL_HIGH_ANDROIDX, 1) \
    _(XR_SCENE_MESH_LEVEL_OF_DETAIL_MEDIUM_ANDROIDX, 2) \
    _(XR_SCENE_MESH_LEVEL_OF_DETAIL_LOW_ANDROIDX, 3) \
    _(XR_SCENE_MESH_LEVEL_OFDETAIL_MAX_ENUM_ANDROIDX, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSceneMeshSemanticLabelANDROIDX(_) \
    _(XR_SCENE_MESH_SEMANTIC_LABEL_OTHER_ANDROIDX, 0) \
    _(XR_SCENE_MESH_SEMANTIC_LABEL_FLOOR_ANDROIDX, 1) \
    _(XR_SCENE_MESH_SEMANTIC_LABEL_CEILING_ANDROIDX, 2) \
    _(XR_SCENE_MESH_SEMANTIC_LABEL_WALL_ANDROIDX, 3) \
    _(XR_SCENE_MESH_SEMANTIC_LABEL_TABLE_ANDROIDX, 4) \
    _(XR_SCENE_MESH_SEMANTIC_LABEL_MAX_ENUM_ANDROIDX, 0x7FFFFFFF)
...
/// Calls your macro with the name of each member of XrSceneMeshBaseHeaderANDROIDX, in order.
#define XR_LIST_STRUCT_XrSceneMeshBaseHeaderANDROIDX(_) \
    _(type) \
    _(next) \
    _(submeshCount) \
    _(submeshes) \
...
/// Calls your macro with the name of each member of XrSceneMeshCpuANDROIDX, in order.
#define XR_LIST_STRUCT_XrSceneMeshCpuANDROIDX(_) \
    _(type) \
    _(next) \
    _(submeshCount) \
    _(submeshes) \
...
/// Calls your macro with the name of each member of XrSceneMeshHardwareANDROIDX, in order.
#define XR_LIST_STRUCT_XrSceneMeshHardwareANDROIDX(_) \
    _(type) \
    _(next) \
    _(submeshCount) \
    _(submeshes) \
...
#define XR_LIST_STRUCTURE_TYPES_CORE(_) \
    ...
    _(XrSceneMeshCpuANDROIDX, XR_TYPE_SCENE_MESH_CPU_ANDROIDX) \
...
#define XR_LIST_STRUCTURE_TYPES_XR_USE_PLATFORM_ANDROID(_) \
    ...
    _(XrSceneMeshHardwareANDROIDX, XR_TYPE_SCENE_MESH_HARDWARE_ANDROIDX) \
...
#define XR_LIST_EXTENSIONS(_) \
    ...
    _(XR_ANDROIDX_scene_meshing_android_hardware_buffer, 710) \
