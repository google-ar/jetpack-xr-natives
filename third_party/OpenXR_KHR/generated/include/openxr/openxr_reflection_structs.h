...
#define _impl_XR_LIST_ALL_STRUCTURE_TYPES_CORE(_avail, _unavail) \
    ...
    _avail(XrSystemQrCodeTrackingPropertiesANDROID, XR_TYPE_SYSTEM_QR_CODE_TRACKING_PROPERTIES_ANDROID) \
    _avail(XrTrackableQrCodeConfigurationANDROID, XR_TYPE_TRACKABLE_QR_CODE_CONFIGURATION_ANDROID) \
    _avail(XrTrackableQrCodeANDROID, XR_TYPE_TRACKABLE_QR_CODE_ANDROID) \
    ...
    _avail(XrSystemAdvancedLightEstimationPropertiesANDROID, XR_TYPE_SYSTEM_ADVANCED_LIGHT_ESTIMATION_PROPERTIES_ANDROID) \
    _avail(XrAdvancedLightEstimatorCreateInfoANDROID, XR_TYPE_ADVANCED_LIGHT_ESTIMATOR_CREATE_INFO_ANDROID) \
    _avail(XrLightingCubemapDataANDROID, XR_TYPE_LIGHTING_CUBEMAP_DATA_ANDROID) \
    _avail(XrPointLightsANDROID, XR_TYPE_POINT_LIGHTS_ANDROID) \
    ...
    _avail(XrSpatialBoundsRaycastANDROID, XR_TYPE_SPATIAL_BOUNDS_RAYCAST_ANDROID) \
    _avail(XrSpatialComponentRaycastResultListANDROID, XR_TYPE_SPATIAL_COMPONENT_RAYCAST_RESULT_LIST_ANDROID) \
    _avail(XrSystemGeospatialPropertiesANDROIDX1, XR_TYPE_SYSTEM_GEOSPATIAL_PROPERTIES_ANDROIDX1) \
    _avail(XrEarthTrackerCreateInfoANDROIDX1, XR_TYPE_EARTH_TRACKER_CREATE_INFO_ANDROIDX1) \
    _avail(XrEventDataEarthTrackerStateChangedANDROIDX1, XR_TYPE_EVENT_DATA_EARTH_TRACKER_STATE_CHANGED_ANDROIDX1) \
    _avail(XrGeospatialAnchorCreateInfoANDROIDX1, XR_TYPE_GEOSPATIAL_ANCHOR_CREATE_INFO_ANDROIDX1) \
    _avail(XrGeospatialPoseLocateInfoANDROIDX1, XR_TYPE_GEOSPATIAL_POSE_LOCATE_INFO_ANDROIDX1) \
    _avail(XrGeospatialPoseResultANDROIDX1, XR_TYPE_GEOSPATIAL_POSE_RESULT_ANDROIDX1) \
    _avail(XrPoseFromGeospatialPoseLocateInfoANDROIDX1, XR_TYPE_POSE_FROM_GEOSPATIAL_POSE_LOCATE_INFO_ANDROIDX1) \
    _avail(XrSurfaceAnchorCreateInfoANDROIDX1, XR_TYPE_SURFACE_ANCHOR_CREATE_INFO_ANDROIDX1) \
    ...
    _avail(XrSpatialComponentRoomListANDROIDX1, XR_TYPE_SPATIAL_COMPONENT_ROOM_LIST_ANDROIDX1) \
    _avail(XrSpatialComponentMaterialTypeListANDROIDX1, XR_TYPE_SPATIAL_COMPONENT_MATERIAL_TYPE_LIST_ANDROIDX1) \
    _avail(XrSpatialComponentConfidenceListANDROIDX1, XR_TYPE_SPATIAL_COMPONENT_CONFIDENCE_LIST_ANDROIDX1) \
    _avail(XrSpatialComponentRoomEmptinessListANDROIDX1, XR_TYPE_SPATIAL_COMPONENT_ROOM_EMPTINESS_LIST_ANDROIDX1) \
    _avail(XrSpatialDiscoveryRoomBoundaryFilterANDROIDX1, XR_TYPE_SPATIAL_DISCOVERY_ROOM_BOUNDARY_FILTER_ANDROIDX1) \
    _avail(XrSpatialComponentOccupancyGridListANDROIDX1, XR_TYPE_SPATIAL_COMPONENT_OCCUPANCY_GRID_LIST_ANDROIDX1) \
    _avail(XrSpatialAnchorSpaceFromIdCreateInfoANDROIDX1, XR_TYPE_SPATIAL_ANCHOR_SPACE_FROM_ID_CREATE_INFO_ANDROIDX1) \
