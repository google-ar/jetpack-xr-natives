...
#ifndef THIRD_PARTY_SPLIT_ENGINE_MATERIALS_GSPLAT_BACKGROUND_MATERIAL_H_
#define THIRD_PARTY_SPLIT_ENGINE_MATERIALS_GSPLAT_BACKGROUND_MATERIAL_H_
...
class GsplatBackgroundMaterial : public imp::split_engine::SplitEngineMaterial {
 public:
  static imp::Future<std::unique_ptr<GsplatBackgroundMaterial>> Create(
      imp::BaseView& view);

  ~GsplatBackgroundMaterial() override;
...
#endif  // THIRD_PARTY_SPLIT_ENGINE_MATERIALS_GSPLAT_BACKGROUND_MATERIAL_H_
