...
#include "filament/libs/generated/resources/iblprefilter_materials.h"
...
Texture* IBLPrefilterContext::EquirectangularToCubemap::operator()(
    ...
    for (size_t i = 0; i < 2; i++) {
        // This is a workaround for internal bug (broken link) to duplicate same material for each draw.
