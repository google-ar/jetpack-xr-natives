...
GLuint ShaderCompilerService::initialize(program_token_t& token) noexcept {
    ...
    // TODO: This is a temoporary change to prove that this fixes the crash. A proper
    // fix will be made later once it's proved.
    // This code is harmless because at this point we don't need to execute the TickOp to check
