...
absl::Status SplitEngineBridgeSender::EnqueueMessageGroup(
...
absl::Status SplitEngineBridgeSender::ReleaseMessageGroup(
    ClientId client_id, MessageGroupId message_group_id) {
  MessageGroupTrackingData& message_group_tracking_data =
      GetActiveMessageGroups();
  absl::MutexLock lock(message_group_tracking_data.mutex);
...
absl::Status SplitEngineBridgeSender::WithActiveMessageGroups(
    ClientId client_id,
