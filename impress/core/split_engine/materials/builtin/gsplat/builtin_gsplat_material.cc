...
split_engine::BuiltInMaterialPtr BuiltInGSplatMaterial::Duplicate() const {
  return absl::WrapUnique(new BuiltInGSplatMaterial(
      view_, GetBridgeId(),
