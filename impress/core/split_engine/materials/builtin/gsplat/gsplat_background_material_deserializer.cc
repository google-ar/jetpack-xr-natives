...
Future<BuiltInMaterialPtr> GsplatBackgroundMaterialDeserializer::Create(
  ...
  return view.GetAssetManager()
      ...
      .Then([&view, bridge_id](
        ...
        return absl::WrapUnique(new GsplatBackgroundMaterialDeserializer(
            view, bridge_id,
            view.GetMaterialFactory().CreateMaterial(material_asset)));
      });
}
GsplatBackgroundMaterialDeserializer::GsplatBackgroundMaterialDeserializer(
    BaseView& view, BridgeId bridge_id, OwnedMaterialPtr material)
    : BuiltInCustomMaterial(bridge_id, std::move(material)), view_(view) {}

absl::Status GsplatBackgroundMaterialDeserializer::SetParameters(
...
GsplatBackgroundMaterialDeserializer::Duplicate() const {
  return absl::WrapUnique(new GsplatBackgroundMaterialDeserializer(
      view_, GetBridgeId(),
