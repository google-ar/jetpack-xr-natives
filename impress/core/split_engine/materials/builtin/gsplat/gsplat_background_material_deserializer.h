...
#ifndef THIRD_PARTY_IMPRESS_CORE_SPLIT_ENGINE_MATERIALS_BUILTIN_GSPLAT_GSPLAT_BACKGROUND_MATERIAL_DESERIALIZER_H_
...
// filament material.
//
// Access via GsplatBackgroundMaterialSerializer instead of making changes here
// directly.
class GsplatBackgroundMaterialDeserializer : public BuiltInCustomMaterial {
 public:
 ...
 private:
  GsplatBackgroundMaterialDeserializer(BaseView& view, BridgeId bridge_id,
...
#endif  // THIRD_PARTY_IMPRESS_CORE_SPLIT_ENGINE_MATERIALS_BUILTIN_GSPLAT_GSPLAT_BACKGROUND_MATERIAL_DESERIALIZER_H_
