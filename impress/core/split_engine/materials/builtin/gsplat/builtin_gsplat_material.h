...
#ifndef THIRD_PARTY_SPLIT_ENGINE_MATERIALS_GSPLAT_GSPLAT_MATERIAL_H_
#define THIRD_PARTY_SPLIT_ENGINE_MATERIALS_GSPLAT_GSPLAT_MATERIAL_H_
...
class BuiltInGSplatMaterial : public BuiltInCustomMaterial {
 public:
 ...
 private:
  BuiltInGSplatMaterial(BaseView& view, BridgeId bridge_id,
                        OwnedMaterialPtr material);
  BaseView& view_;
};

}  // namespace imp::split_engine
#endif  // THIRD_PARTY_SPLIT_ENGINE_MATERIALS_GSPLAT_GSPLAT_MATERIAL_H_
