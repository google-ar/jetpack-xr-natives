...
#ifndef THIRD_PARTY_IMPRESS_CORE_SPLIT_ENGINE_MATERIALS_BUILTIN_BUILTIN_YOUTUBE_STEREO_PLAYER_MATERIAL_H_
#define THIRD_PARTY_IMPRESS_CORE_SPLIT_ENGINE_MATERIALS_BUILTIN_BUILTIN_YOUTUBE_STEREO_PLAYER_MATERIAL_H_
...
// The built-in material for YouTubeVR stereo player.
class BuiltInYouTubeStereoPlayerMaterial : public BuiltInCustomMaterial {
 public:
  ...
  // The YTXR always requires display color space to be P3.
 ...
 private:
  ...
  std::optional<TextureId> texture_id_;
};

}  // namespace imp::split_engine

#endif  // THIRD_PARTY_IMPRESS_CORE_SPLIT_ENGINE_MATERIALS_BUILTIN_BUILTIN_YOUTUBE_STEREO_PLAYER_MATERIAL_H_
