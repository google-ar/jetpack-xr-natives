...
#ifndef THIRD_PARTY_IMPRESS_CORE_SPLIT_ENGINE_MATERIALS_BUILTIN_BUILTIN_SVXR_PLANE_MATERIAL_H_
#define THIRD_PARTY_IMPRESS_CORE_SPLIT_ENGINE_MATERIALS_BUILTIN_BUILTIN_SVXR_PLANE_MATERIAL_H_
...
class BuiltInSVXRPlaneMaterial : public BuiltInCustomMaterial {
 public:
 ...
 private:
  BuiltInSVXRPlaneMaterial(BaseView& view, OwnedMaterialPtr material);
...
#endif  // THIRD_PARTY_IMPRESS_CORE_SPLIT_ENGINE_MATERIALS_BUILTIN_BUILTIN_SVXR_PLANE_MATERIAL_H_
