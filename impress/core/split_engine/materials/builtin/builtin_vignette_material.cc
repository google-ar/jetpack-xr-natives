...
absl::Status BuiltInVignetteMaterial::SetParameters(
  ...
  if (parameters.data_type() != android_xr::schemas::BuiltInMaterialParameters::
    ...
    return absl::InvalidArgumentError(
        "This material requires BuiltInMaterialE3ca0ab9Parameters");
  }
  ...
  const android_xr::schemas::BuiltInMaterialE3ca0ab9Parameters* schema =
      parameters
          .data_as<android_xr::schemas::BuiltInMaterialE3ca0ab9Parameters>();
  if (schema->color()) {
    GetMaterial()->SetParameter("color", UnPack(*schema->color()));
  }
  GetMaterial()->SetParameter("coverage", schema->coverage());
