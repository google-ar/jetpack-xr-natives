...
#ifndef THIRD_PARTY_IMPRESS_CORE_SPLIT_ENGINE_MATERIALS_BUILTIN_BUILTIN_VIGNETTE_MATERIAL_H_
#define THIRD_PARTY_IMPRESS_CORE_SPLIT_ENGINE_MATERIALS_BUILTIN_BUILTIN_VIGNETTE_MATERIAL_H_
...
// The built-in material for a screen-space vignette effect.
class BuiltInVignetteMaterial : public BuiltInCustomMaterial {
 public:
...
#endif  // THIRD_PARTY_IMPRESS_CORE_SPLIT_ENGINE_MATERIALS_BUILTIN_BUILTIN_VIGNETTE_MATERIAL_H_
