...
#ifndef THIRD_PARTY_IMPRESS_CORE_SPLIT_ENGINE_MATERIALS_BUILTIN_BUILTIN_TEXTURE_EXTERNAL_MATERIAL_H_
#define THIRD_PARTY_IMPRESS_CORE_SPLIT_ENGINE_MATERIALS_BUILTIN_BUILTIN_TEXTURE_EXTERNAL_MATERIAL_H_
...
// The built-in material for rendering an external texture.
class BuiltInTextureExternalMaterial : public BuiltInCustomMaterial {
 public:
...
#endif  // THIRD_PARTY_IMPRESS_CORE_SPLIT_ENGINE_MATERIALS_BUILTIN_BUILTIN_TEXTURE_EXTERNAL_MATERIAL_H_
