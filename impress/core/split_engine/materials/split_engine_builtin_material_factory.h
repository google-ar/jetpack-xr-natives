...
#ifndef THIRD_PARTY_IMPRESS_CORE_SPLIT_ENGINE_MATERIALS_SPLIT_ENGINE_BUILTIN_MATERIAL_FACTORY_H_
#define THIRD_PARTY_IMPRESS_CORE_SPLIT_ENGINE_MATERIALS_SPLIT_ENGINE_BUILTIN_MATERIAL_FACTORY_H_
...
class SplitEngineBuiltinMaterialFactory {
 public:
  ...
  SplitEngineBuiltinMaterialFactory(BaseView& view);
...
#endif  // THIRD_PARTY_IMPRESS_CORE_SPLIT_ENGINE_MATERIALS_SPLIT_ENGINE_BUILTIN_MATERIAL_FACTORY_H_
