...
#ifndef THIRD_PARTY_IMPRESS_CORE_MODEL_MESH_MESH_FACTORY_H_
#define THIRD_PARTY_IMPRESS_CORE_MODEL_MESH_MESH_FACTORY_H_
...
#endif  // THIRD_PARTY_IMPRESS_CORE_MODEL_MESH_MESH_FACTORY_H_
