 ...
 */
#ifndef THIRD_PARTY_IMPRESS_CORE_MATERIALCOMPILER_MATERIAL_COMPILER_CLIENT_H_
#define THIRD_PARTY_IMPRESS_CORE_MATERIALCOMPILER_MATERIAL_COMPILER_CLIENT_H_
...
#endif  // THIRD_PARTY_IMPRESS_CORE_MATERIALCOMPILER_MATERIAL_COMPILER_CLIENT_H_
