...
#ifndef THIRD_PARTY_IMPRESS_CORE_RENDER_PRIMITIVE_SHAPE_RENDERER_H_
#define THIRD_PARTY_IMPRESS_CORE_RENDER_PRIMITIVE_SHAPE_RENDERER_H_
...
#endif  // THIRD_PARTY_IMPRESS_CORE_RENDER_PRIMITIVE_SHAPE_RENDERER_H_
