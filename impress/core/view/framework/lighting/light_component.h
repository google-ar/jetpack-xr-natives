...
#ifndef THIRD_PARTY_IMPRESS_CORE_VIEW_FRAMEWORK_LIGHTING_LIGHT_COMPONENT_H_
#define THIRD_PARTY_IMPRESS_CORE_VIEW_FRAMEWORK_LIGHTING_LIGHT_COMPONENT_H_
...
#endif  // THIRD_PARTY_IMPRESS_CORE_VIEW_FRAMEWORK_LIGHTING_LIGHT_COMPONENT_H_
