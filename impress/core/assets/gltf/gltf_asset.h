...
#ifndef THIRD_PARTY_IMPRESS_CORE_ASSETS_GLTF_GLTF_ASSET_H_
#define THIRD_PARTY_IMPRESS_CORE_ASSETS_GLTF_GLTF_ASSET_H_
...
#endif  // THIRD_PARTY_IMPRESS_CORE_ASSETS_GLTF_GLTF_ASSET_H_
