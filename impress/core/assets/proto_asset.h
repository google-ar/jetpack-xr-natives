...
#ifndef THIRD_PARTY_IMPRESS_CORE_ASSETS_PROTO_ASSET_H_
#define THIRD_PARTY_IMPRESS_CORE_ASSETS_PROTO_ASSET_H_
...
#if IMP_RUNTIME(DEV)
            proto = T();
            // This is needed for reading textprotos at runtime.
            if (!proto::ParseTextproto(resource.GetData().StringView(), &proto)
                     .ok()) {
              return absl::InvalidArgumentError("Unable to parse proto.");
            }
#else
...
#endif  // THIRD_PARTY_IMPRESS_CORE_ASSETS_PROTO_ASSET_H_
