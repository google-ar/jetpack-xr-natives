...
// RecipeExecutionContext contains the runtime context for executing a
// RecipeGraph.
// TODO Improve the management of RecipeScope, currently this
// member scope has to match the active scope of the member async_manager
...
#endif  // THIRD_PARTY_IMPRESS_CORE_RECIPES_LANGUAGE_RECIPE_EXECUTION_CONTEXT_H_
