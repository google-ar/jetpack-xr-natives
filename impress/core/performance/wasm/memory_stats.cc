...
thread_local size_t allocated_bytes_this_frame_ = 0;
thread_local size_t allocations_count_this_frame_ = 0;

size_t MemoryStats::GetMemoryBytesAllocatedOnThisThread() {
  return allocated_bytes_this_frame_;
}
size_t MemoryStats::GetAllocationsCountOnThisThread() {
  return allocations_count_this_frame_;
}
void MemoryStats::ResetMemoryCountersForThisThread() {
  allocated_bytes_this_frame_ = 0;
  allocations_count_this_frame_ = 0;
}
...
void MemoryStats::IncrementMemoryCounters(size_t size) {
  allocated_bytes_this_frame_ += size;
  allocations_count_this_frame_++;
