...
#ifndef THIRD_PARTY_IMPRESS_CORE_EDITOR_UI_DIRECTORY_UI_NOOP_H_
#define THIRD_PARTY_IMPRESS_CORE_EDITOR_UI_DIRECTORY_UI_NOOP_H_
...
class DirectoryUiNoop : public DirectoryUi {
 public:
...
#endif  // THIRD_PARTY_IMPRESS_CORE_EDITOR_UI_DIRECTORY_UI_NOOP_H_
