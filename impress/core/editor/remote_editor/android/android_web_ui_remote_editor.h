...
#ifndef THIRD_PARTY_IMPRESS_CORE_EDITOR_REMOTE_EDITOR_ANDROID_ANDROID_WEB_UI_REMOTE_EDITOR_H_
#define THIRD_PARTY_IMPRESS_CORE_EDITOR_REMOTE_EDITOR_ANDROID_ANDROID_WEB_UI_REMOTE_EDITOR_H_
...
#include "core/editor/remote_editor/android/android_remote_editor_wrapper.h"
...
class AndroidWebUiRemoteEditor : public WebUiRemoteEditor,
 ...
 private:
  ...
  int http_port_ = 0;
  int script_api_bridge_port_ = 0;
  int ui_streaming_port_ = 0;
};

}  // namespace imp::editor

#endif  // THIRD_PARTY_IMPRESS_CORE_EDITOR_REMOTE_EDITOR_ANDROID_ANDROID_WEB_UI_REMOTE_EDITOR_H_
