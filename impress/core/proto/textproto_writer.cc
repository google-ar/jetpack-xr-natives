...
StringMap<TextprotoWriter::VisitRegisteredAnyFn>*
TextprotoWriter::GetVisitRegisteredFnMap() {
  // It's best to store static data structures as a static pointer inside of
  // a static function, per (broken link) and (broken link).
  static StringMap<TextprotoWriter::VisitRegisteredAnyFn>*
      visit_registered_fn_map =
          new StringMap<TextprotoWriter::VisitRegisteredAnyFn>();
  return visit_registered_fn_map;
}

void TextprotoWriter::ClearRegisteredTypes() {
