...
enum class AttributeType {
  ...
  // Position, may be either world or local space. (float3, x, y, z)
  kPosition,
...
DataLayout::DataLayout(/* particle_description */) {
  ...
  // TODO: (broken link) - Infer used fields from the particle description. The
  // following code is placeholder until the particle description is defined.
