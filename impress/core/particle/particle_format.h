...
#ifndef THIRD_PARTY_IMPRESS_CORE_PARTICLE_PARTICLE_FORMAT_H_
#define THIRD_PARTY_IMPRESS_CORE_PARTICLE_PARTICLE_FORMAT_H_
...
#endif  // THIRD_PARTY_IMPRESS_CORE_PARTICLE_PARTICLE_FORMAT_H_
