...
#ifndef THIRD_PARTY_IMPRESS_CORE_VIDEO_VIDEO_COLOR_SPACE_H_
#define THIRD_PARTY_IMPRESS_CORE_VIDEO_VIDEO_COLOR_SPACE_H_
...
class VideoColorSpace {
 public:
  ...
  VideoColorSpace(Standard standard, Transfer transfer, Range range);
  ...
  VideoColorSpace(int32_t dataspace);
  VideoColorSpace(ADataSpace dataspace);
  VideoColorSpace(HalDataspace dataspace);
#endif  // IMP_PLATFORM(ANDROID)
  ...
  void SetMaxContentLightLevel(float content_light_level);
  ...
  float GetMaxContentLightLevel() const;
 ...
 private:
  ...
  float max_content_light_level_ = -1.0f;
...
#endif  // THIRD_PARTY_IMPRESS_CORE_VIDEO_VIDEO_COLOR_SPACE_H_
