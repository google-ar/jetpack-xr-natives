...
#ifndef THIRD_PARTY_IMPRESS_CORE_PHYSICS_COLLIDABLE_SHAPES_COMPOUND_COLLIDABLE_SHAPE_H_
#define THIRD_PARTY_IMPRESS_CORE_PHYSICS_COLLIDABLE_SHAPES_COMPOUND_COLLIDABLE_SHAPE_H_
...
// This class deals with Bullet compound collision shapes.
class CompoundCollidableShape : public CollidableShape {
 public:
  CompoundCollidableShape(NodeHandle node);
 ...
 private:
  ...
  std::vector<std::unique_ptr<CollidableShape>> child_shapes_;
  // Local offset of the center of the compound shape in Impress.
...
#endif  // THIRD_PARTY_IMPRESS_CORE_PHYSICS_COLLIDABLE_SHAPES_COMPOUND_COLLIDABLE_SHAPE_H_
