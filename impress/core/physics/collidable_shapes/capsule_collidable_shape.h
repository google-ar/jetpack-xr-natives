...
#ifndef THIRD_PARTY_IMPRESS_CORE_PHYSICS_COLLIDABLE_SHAPES_CAPSULE_COLLIDABLE_SHAPE_H_
#define THIRD_PARTY_IMPRESS_CORE_PHYSICS_COLLIDABLE_SHAPES_CAPSULE_COLLIDABLE_SHAPE_H_
...
// This class deals with Bullet capsule collision shapes.
class CapsuleCollidableShape : public CollidableShape {
 public:
  CapsuleCollidableShape(NodeHandle node);
...
#endif  // THIRD_PARTY_IMPRESS_CORE_PHYSICS_COLLIDABLE_SHAPES_CAPSULE_COLLIDABLE_SHAPE_H_
