...
#ifndef THIRD_PARTY_IMPRESS_CORE_PHYSICS_COLLIDABLE_SHAPES_SPHERE_COLLIDABLE_SHAPE_H_
#define THIRD_PARTY_IMPRESS_CORE_PHYSICS_COLLIDABLE_SHAPES_SPHERE_COLLIDABLE_SHAPE_H_
...
// This class deals with Bullet sphere collision shapes.
class SphereCollidableShape : public CollidableShape {
 public:
...
#endif  // THIRD_PARTY_IMPRESS_CORE_PHYSICS_COLLIDABLE_SHAPES_SPHERE_COLLIDABLE_SHAPE_H_
