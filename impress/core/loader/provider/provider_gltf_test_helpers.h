...
#ifndef THIRD_PARTY_IMPRESS_CORE_LOADER_PROVIDER_PROVIDER_GLTF_TEST_HELPERS_H_
#define THIRD_PARTY_IMPRESS_CORE_LOADER_PROVIDER_PROVIDER_GLTF_TEST_HELPERS_H_
...
class ProviderGltfTestHelpers {
 public:
  ProviderGltfTestHelpers();

 protected:
  std::string GetSampleAssetsDirectory();
  std::string SampleAsset(std::string friendly_path);
  OptionalError CreateProvider(std::string friendly_path);
  OptionalError CreateProvider(std::string friendly_path,
...
#endif  // THIRD_PARTY_IMPRESS_CORE_LOADER_PROVIDER_PROVIDER_GLTF_TEST_HELPERS_H_
