...
#define JNI_METHOD(return_type, method_name) \
  IMP_JNI return_type JNICALL                \
      Java_com_google_ar_sceneform_ipc_LoaderService_##method_name
...
(JNIEnv* env, jclass /*clazz*/, jint fd) {
  ...
  return ToJava<LoaderService>(service.release());
}
...
// LINT.ThenChange(
//     //depot/google3/third_party/arcore/java/com/google/ar/sceneform/ipc/LoaderService.java:api
// )
