...
def imp_desktop_split_engine_app(
        name,
        impress_library,
        extra_linkopts = [],
        tags = [],
    ...
    Args:
      name: Name of the imp_app rule. This helper will generate the target
    ...
    for target_type, testonly in (("desktop_split_engine", False), ("desktop_split_engine", True)):
        ...
        cc_binary(
            ...
            deps = [
                       impress_library,
                       Label("@com_google_impress//:platform_desktop_split_engine"),
                   ] +
    ...
    build_test(
        ...
        tags = ["impress_app_build_test_desktop_split_engine"],
    )
