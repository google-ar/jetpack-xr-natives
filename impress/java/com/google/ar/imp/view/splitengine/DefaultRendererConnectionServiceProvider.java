...
public class DefaultRendererConnectionServiceProvider
    implements ServiceConnection, RendererConnectionServiceProvider {
   ...
   */
  public DefaultRendererConnectionServiceProvider(
  ...
  public void onBridgeReady(
      RendererConnectionServiceProvider.RendererConnectionReadyCallback bridgeCallback) {
  ...
  public void initializeService(Context context, IBinder serviceBinder) {
    ...
    if (serviceBinder != null) {
      ...
      context.bindService(
          serviceIntent, DefaultRendererConnectionServiceProvider.this, Context.BIND_AUTO_CREATE);
    }
  }
}
