...
public class KhronosPbrMaterial extends Material {
  ...
  public void setBaseColorUvTransform(
      float ux, float uy, float uz, float vx, float vy, float vz, float wx, float wy, float wz) {
    impressApi.setBaseColorUvTransformOnKhronosPbrMaterial(
        getNativeHandle(), ux, uy, uz, vx, vy, vz, wx, wy, wz);
  }

  /**
   * Sets the base color factors for the Khronos PBR material. These factors multiply the base color
   * texture or defines a uniform base color.
   *
  ...
  /**
   * Sets the metallic factor for the Khronos PBR material. Controls the metalness of the material,
   * ranging from non-metal to metal.
   *
  ...
  /**
   * Sets the UV transformation matrix for the normal map texture. Adjusts the mapping of the normal
   * map texture.
   *
   * @param ux The X component of the first row of the transformation matrix.
   * @param uy The Y component of the first row of the transformation matrix.
  ...
  /**
   * Sets the factor of the normal map effect. Controls the strength of the normal map's influence.
   *
  ...
  public void setTransmissionTexture(long transmissionTexture) {
    impressApi.setTransmissionTextureOnKhronosPbrMaterial(getNativeHandle(), transmissionTexture);
  }
  ...
  public static class Builder {
    ...
    public Builder setImpressApi(ImpressApi impressApi) {
